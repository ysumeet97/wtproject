	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
{
	...
	out.println("<tr><th align='left' width='90%'><h1 style='font-size:50px;'><a href='anime2.html' style='text-decoration:none;'>GoAnime</a></h1></th><th align='center' style='font-size:20px'> <form action=' ' method='get' style='border:2px solid #ccc;border-radius:4px;'><input type='text' name='Search' placeholder='Search..'background-color='white'></form></th></tr></table>");
